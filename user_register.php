...
<section class="form-container">
    ...
    <form action="" method="POST">
        ...
        <h3>Register Now</h3>
        <input type="text" name="name" maxlength="20" placeholder="enter your name" class="box" oninput="this.value = this.value.replace(/\s/g, '')"  required>
        ...
        <input type="password" name="cpass" maxlength="20" placeholder="confirm your password" class="box" oninput="this.value = this.value.replace(/\s/g, '')"  required>
